TEXTS = {
    ...
    'account_check_proxies_used': '· Proxy đã sử dụng: {count}',
    'account_check_fallback_local': '· Dự phòng cục bộ: {count}',
    'account_check_failed_proxies': '· Thất Bại proxy: {count}',
    ...
    'files_sent_count': '· Thành Côngđã gửi đầy đủ: {count} tệp',
    'check_mode_summary': '· Kiểm tra mode: {mode}',
    'check_duration': '· Kiểm tra duration: {seconds}s',
    'thanks_message': 'Cảm ơn bạn đã sử dụng bot! Để kiểm tra lại, nhấp /start',
    
    # proxy stats and other statistics
    'total_accounts': 'Tổng Số Tài Khoản',
    'proxy_usage_stats': '📡 Thống kê sử dụng proxy',
    'proxies_used_stat': 'Proxy đã sử dụng',
    'fallback_local_stat': 'Dự phòng Cục bộ',
    'failed_proxies_stat': 'Thất Bại Proxies',
    'local_only_stat': 'Cục bộ Chỉ',
    ...
    'format_conversion_tdata_to_session_desc1': '· Chuyển đổi Telegram Máy tính tdata định dạng thành Session format',
    ...
    'format_conversion_session_to_tdata_desc1': '· Chuyển đổi Session định dạng thành Telegram Máy tính tdata format',
    'format_conversion_session_to_tdata_desc2': '· For Telegram Máy tính client',
    ...
    'conversion_failed': '· ❌ Thất Bại: {count}',
    ...
    'zip_conversion_failed': 'conversion_faiđã-{count}',
    'file_desc_conversion_success': '📦 Chuyển đổi success ({count} tài khoản)',
    'file_desc_conversion_failed': '📦 Chuyển đổi faiđã ({count} tài khoản)',
    'report_filename_success': 'session_to_tdata_success-report.txt',
    'report_filename_failed': 'conversion_faiđã-report.txt',
    'report_desc_success': '📋 Chuyển đổi Thành Công Detaiđã Báo cáo',
    'report_desc_failed': '📋 Chuyển đổi Thất Bại Detaiđã Báo cáo',
    ...
    'conversion_failed_percent': '· ❌ Thất Bại: {count} ({percent}%)',
    ...
    'report_title_failed': 'Chuyển Đổi Định Dạng Báo cáo - Thất Bại',
    ...
    'forget_2fa_proxy_warning': '⚠️ Warning: Insufficient proxy! Chỉ {count} available, recommend at least 10',
    ...
    'report_delete_2fa_error_session_not_found': 'Chuyển đổied session file not found',
    ...
    'merge_zip_only': '⚠️ Chỉ .zip tệp accepted',
    ...
    'merge_zip_only_error': '❌ Chỉ .zip tệp supported, please re-upload',
    ...
    'broadcast_media_note2': 'Chỉ one image per broadcast',
