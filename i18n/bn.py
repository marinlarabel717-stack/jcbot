TEXTS = {
    ...
    'account_check_proxy_disabled': '🌐 প্রক্সি মোড: নিষ্ক্রিয়',
    ...
    'account_check_proxies_used': '· ব্যবহৃত প্রক্সি: {count}',
    'account_check_fallback_local': '· ফলব্যাক স্থানীয়: {count}',
    'account_check_failed_proxies': '· ব্যর্থ প্রক্সি: {count}',
    ...
    'files_sent_count': '· সফলসম্পূর্ণভাবে পাঠানো: {count} ফাইল',
    'check_mode_summary': '· চেক mode: {mode}',
    'check_duration': '· চেক duration: {seconds}s',
    'thanks_message': 'বট ব্যবহার করার জন্য ধন্যবাদ! আবার চেক করতে, /start ক্লিক করুন',
    
    # প্রক্সি stats and other statistics
    'total_accounts': 'মোট অ্যাকাউন্ট',
    'proxy_usage_stats': '📡 প্রক্সি ব্যবহার পরিসংখ্যান',
    'proxies_used_stat': 'ব্যবহৃত প্রক্সি',
    'fallback_local_stat': 'ফলব্যাক স্থানীয়',
    'failed_proxies_stat': 'ব্যর্থ Proxies',
    'local_only_stat': 'স্থানীয় শুধুমাত্র',
    ...
    'format_conversion_tdata_to_session_desc1': '· রূপান্তর টেলিগ্রাম ডেস্কটপ tdata ফরম্যাট Session format',
    ...
    'format_conversion_session_to_tdata_desc1': '· রূপান্তর Session ফরম্যাট টেলিগ্রাম ডেস্কটপ tdata format',
    'format_conversion_session_to_tdata_desc2': '· For টেলিগ্রাম ডেস্কটপ client',
    ...
    'conversion_failed': '· ❌ ব্যর্থ: {count}',
    ...
    'zip_conversion_failed': 'conversion_faiহয়েছে-{count}',
    'file_desc_conversion_success': '📦 রূপান্তর success ({count} অ্যাকাউন্ট)',
    'file_desc_conversion_failed': '📦 রূপান্তর faiহয়েছে ({count} অ্যাকাউন্ট)',
    'report_filename_success': 'session_to_tdata_success-report.txt',
    'report_filename_failed': 'conversion_faiহয়েছে-report.txt',
    'report_desc_success': '📋 রূপান্তর সফল Detaiহয়েছে রিপোর্ট',
    'report_desc_failed': '📋 রূপান্তর ব্যর্থ Detaiহয়েছে রিপোর্ট',
    ...
    'conversion_failed_percent': '· ❌ ব্যর্থ: {count} ({percent}%)',
    ...
    'forget_2fa_proxy_warning': '⚠️ Warning: Insufficient প্রক্সি! শুধুমাত্র {count} available, recommend at least 10',
    ...
    'report_delete_2fa_error_session_not_found': 'রূপান্তরed session file not found',
    ...
    'merge_zip_only': '⚠️ শুধুমাত্র .zip ফাইল accepted',
    ...
    'merge_zip_only_error': '❌ শুধুমাত্র .zip ফাইল supported, please re-upload',
    ...
    'broadcast_media_note2': 'শুধুমাত্র one image per broadcast',
    ...
    'broadcast_target_vip': '💎 VIP শুধুমাত্র',
