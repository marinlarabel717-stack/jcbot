TEXTS = {
    ...
    'user_id': 'ID',
    'user_membership': 'عضویت',
    'user_expiry': 'انقضا',
    'status_admin': '👑 مدیر',
    'status_no_member': '❌ بدون عضویت',
    'expiry_permanent': 'دائمی',
    ...
    'proxy_mode_enabled': '🟢فعال',
    'proxy_mode_local': '🔴اتصال محلی',
    'proxy_count_label': 'تعداد پروکسی',
    'proxy_count_value': '{count} پروکسی',
    'current_time': 'زمان فعلی',
    
    # Main menu buttons - actual menu items
    'btn_account_check': '🚀 بررسی اکانت',
    'btn_format_conversion': '🔄 تبدیل فرمت',
    'btn_change_2fa': '🔐 تغییر 2FA',
    'btn_batch_create': '📦 ایجاد دسته ای',
    'btn_forget_2fa': '🔓 فراموشی 2FA',
    'btn_remove_2fa': '❌ حذف 2FA',
    'btn_add_2fa': '➕ افزودن 2FA',
    'btn_classify_menu': '📦 طبقه بندی اکانت',
    'btn_api_conversion': '🔗 تبدیل API',
    'btn_rename_file': '📝 تغییر نام فایل',
    'btn_merge_account': '🧩 ادغام اکانت ها',
    'btn_cleanup': '🧹 پاکسازی یک کلیکی',
    'btn_reauthorize': '🔑 مجوز مجدد',
    'btn_check_registration': '🕰️ بررسی زمان ثبت نام',
    'btn_profile_update': '📝 به روزرسانی پروفایل',
    'btn_check_contact_limit': '🔍 بررسی محدودیت های تماس',
    'btn_vip_menu': '💳 فعال‌سازی/بازخرید عضویت',
    ...
    'account_check_format_session': '· شامل فایل های Session (.session)',
    'account_check_format_session_json': '· شامل Session+JSON فایل (.session + .json)',
    'account_check_format_tdata': '· شامل پوشه های TData',
    'account_check_proxy_enabled': '🌐 حالت پروکسی: فعال ({count} پروکسی)',
    'account_check_proxy_disabled': '🌐 حالت پروکسی: غیرفعال',
    'account_check_upload_hint': 'لطفاً فایل ZIP خود را انتخاب و آپلود کنید...',
    
    # Start check
    'account_check_starting': '⚡ شروع بررسی برای {count} اکانت...',
    'account_check_file_type': '📁 نوع فایل: {type}',
    'account_check_proxy_mode': '🌐 حالت پروکسی',
    'account_check_local_mode': '🔴 حالت محلی',
    ...
    'account_check_format': '· فرمت: {format}',
    ...
    'account_check_proxies_used': '· پروکسی های استفاده شده: {count}',
    'account_check_fallback_local': '· بازگشت محلی: {count}',
    'account_check_failed_proxies': '· ناموفق پروکسی: {count}',
    ...
    'files_sent_count': '· موفقبه طور کامل ارسال شد: {count} فایل',
    'check_mode_summary': '· بررسی mode: {mode}',
    'check_duration': '· بررسی duration: {seconds}s',
    'thanks_message': 'از استفاده از ربات متشکریم! برای بررسی دوباره، /start را کلیک کنید',
    
    # پروکسی stats and other statistics
    'total_accounts': 'مجموع اکانت ها',
    'proxy_usage_stats': '📡 آمار استفاده از پروکسی',
    'proxies_used_stat': 'پروکسی های استفاده شده',
    'fallback_local_stat': 'بازگشت محلی',
    'failed_proxies_stat': 'ناموفق Proxies',
    'local_only_stat': 'محلی فقط',
    ...
    'format_conversion_tdata_to_session_desc1': '· تبدیل تلگرام دسکتاپ tdata فرمت به Session format',
    ...
    'format_conversion_session_to_tdata_desc1': '· تبدیل Session فرمت به تلگرام دسکتاپ tdata format',
    'format_conversion_session_to_tdata_desc2': '· For تلگرام دسکتاپ client',
    ...
    'tdata_to_session_title': '📤 Tdata → Session تبدیل',
    'tdata_to_session_prepare': '📁 Please prepare the following فایل',
    'tdata_to_session_prepare1': '· آرشیو ZIP containing Tdata پوشه',
    'tdata_to_session_prepare2': '· Each Tdata folder should contain D877F783D5D3EF8C directory',
    'conversion_info': '🔧 تبدیل Info',
    'tdata_to_session_info1': '· System will auto-detect all Tdata پوشه',
    'tdata_to_session_info2': '· Batch convert to Session format',
    'tdata_to_session_info3': '· Generate corresponding .session and .json فایل',
    ...
    'session_to_tdata_title': '📥 Session → Tdata تبدیل',
    'session_to_tdata_prepare': '📁 Please prepare the following فایل',
    'session_to_tdata_prepare1': '· آرشیو ZIP containing .session فایل',
    'session_to_tdata_prepare2': '· Optional: corresponding .json config فایل',
    'session_to_tdata_info1': '· System will auto-detect all Session فایل',
    ...
    'conversion_current_progress': '📊 Current پیشرفت',
    'conversion_processed': '· Processed: {done}/{total}',
    'conversion_speed': '· سرعت: {speed}/sec',
    'conversion_elapsed': '· Elapsed: {time}s',
    'conversion_success_count': '✅ تبدیل success: {count}',
    'conversion_error_count': '❌ تبدیل error: {count}',
    ...
    'conversion_failed': '· ❌ ناموفق: {count}',
    'conversion_duration': '· Duration: {time}s',
    'conversion_speed_stat': '· سرعت: {speed}/sec',
    'packing_results': '📦 Packing result فایل...',
    
    # Result file naming
    'zip_session_to_tdata_success': 'session_to_tdata_success-{count}',
    'zip_tdata_to_session_success': 'tdata_to_session_success-{count}',
    'zip_conversion_failed': 'conversion_faiشد-{count}',
    'file_desc_conversion_success': '📦 تبدیل success ({count} اکانت)',
    'file_desc_conversion_failed': '📦 تبدیل faiشد ({count} اکانت)',
    'report_filename_success': 'session_to_tdata_success-report.txt',
    'report_filename_failed': 'conversion_faiشد-report.txt',
    'report_desc_success': '📋 تبدیل موفق Detaiشد گزارش',
    'report_desc_failed': '📋 تبدیل ناموفق Detaiشد گزارش',
    ...
    'conversion_failed_percent': '· ❌ ناموفق: {count} ({percent}%)',
    ...
    'change_2fa_auto_detect': '🔍 Auto رمز عبور Detection',
    ...
    'change_2fa_interactive_input': '✏️ Interactive رمز عبور Input',
    ...
    'change_2fa_note6': 'رمز عبور فایل will auto-update and be included in result ZIP after success',
    ...
    'change_2fa_format1': 'فرمت 1 (Recommended): New password only',
    'change_2fa_format1_example': 'Newرمز عبور123',
    'change_2fa_format1_desc': 'System will auto-detect old password',
    'change_2fa_format2': 'فرمت 2: Old password New password',
    'change_2fa_format2_example': 'OldPass456 Newرمز عبور123',
    'change_2fa_format2_desc': 'If auto-detection fails, your provided old password will be used',
    'change_2fa_tips': '💡 Tips:',
    'change_2fa_tip1': 'Recommended: Use فرمت 1, let system auto-detect',
    'change_2fa_tip2': 'رمز عبور can contain letters, numbers, special characters',
    ...
    'report_2fa_conversion_faiشد': 'تبدیل faiشد: {error}',
    'report_2fa_using_proxy': 'Using proxy',
    'report_2fa_success_updated': 'رمز عبور changed successfully, file updated',
    ...
    'report_2fa_reason_wrong_password_desc1': 'بررسی if password file content is correct',
    'report_2fa_reason_wrong_password_desc2': 'تأیید if password field in JSON is accurate',
    'report_2fa_reason_network': 'Network connection faiشد',
    ...
    'batch_create_feature1': '· Batch create تلگرام groups and channels',
    ...
    'batch_create_step5': '5. Receive detaiشد report and link list after completion',
    ...
    'batch_create_step2_tip3': '💡 ناموفق admins will show detaiشد reasons in report',
    ...
    'batch_create_step3_format': 'فرمت:',
    ...
    'batch_create_confirm_concurrent_accounts': '· Concurrent اکانت: {count}',
    ...
    'report_batch_create_username': 'کاربرname: {username}',
    ...
    'report_failure_list_count': 'ناموفق count: {count}',
    ...
    # ===== Forget 2FA Feature =====
    # 1. Feature Introduction Page
    'forget_2fa_title': '🔓 فراموشی 2FA رمز عبور',
    ...
    'forget_2fa_proxy_warning': '⚠️ Warning: Insufficient پروکسی! فقط {count} available, recommend at least 10',
    'forget_2fa_proxy_status': '📡 Current وضعیت پروکسی',
    'forget_2fa_proxy_mode_enabشد': '· حالت پروکسی: 🟢فعال',
    'forget_2fa_proxy_mode_disabشد': '· حالت پروکسی: 🔴غیرفعال',
    'forget_2fa_proxy_available': '· Available پروکسی: {count}',
    'forget_2fa_upload_prompt': '📤 Please upload account فایل:',
    ...
    'forget_2fa_speed': '⚡ سرعت: {speed}/sec',
    ...
    'zip_forget_2fa_faiشد': 'Forgot2FA_ناموفق_{count}',
    'file_desc_forget_2fa_reset': '📦 فراموشی 2FA - Reset Requested ({count})',
    ...
    'forget_2fa_status_faiشد': 'ناموفق',
    ...
    'delete_2fa_interactive_input': '✏️ Interactive رمز عبور Input',
    ...
    'delete_2fa_note6': 'رمز عبور فایل will auto-update and be included in result ZIP after success',
    ...
    'delete_2fa_auto_detect_title': '🔍 Auto-detect رمز عبور',
    ...
    'delete_2fa_manual_title': '✏️ Manual Input رمز عبور',
    ...
    'delete_2fa_btn_auto': 'Auto-detect رمز عبور',
    ...
    'delete_2fa_final_sent': '· Sent: {count} فایل',
    'delete_2fa_tips': '💡 Tips',
    'delete_2fa_tip1': '· موفقfully deleted اکانت no longer need 2FA password',
    ...
    'report_delete_2fa_error_session_not_found': 'تبدیلed session file not found',
    ...
    'report_delete_2fa_reason_wrong_password_desc1': 'بررسی if password file content is correct',
    'report_delete_2fa_reason_wrong_password_desc2': 'تأیید if password field in JSON is accurate',
    'report_delete_2fa_reason_network': 'Network connection faiشد',
    'report_delete_2fa_reason_network_desc1': 'بررسی if proxy settings are correct',
    ...
    'add_2fa_feature1': '· Auto-create JSON config file for Session فایل',
    ...
    'add_2fa_result_faiشد_desc': '❌ ناموفق',
    ...
    'split_btn_back': '◀️ بازگشت',
    
    # 6. Single Quantity Input
    'split_enter_single': '🔢 Please enter اکانت per package',
    ...
    'country_new_caشدonia': 'New Caشدonia',
    ...
    # Scan complete
    'api_found_accounts': '✅ Found {count} account فایل',
    ...
    'api_progress_success': '· ✅ موفق: {count}',
    ...
    'api_use_again': "✅ To use again /start (Faiشد accounts won't be sent)",
    ...
    'merge_feature3': '· Recursively scan and identify Session فایل (support pure .session or session+json pairs)',
    'merge_feature4': '· Smart classification and archiving',
    'merge_upload_prompt': '📤 Please upload ZIP فایل',
    'merge_zip_only': '⚠️ فقط .zip فایل accepted',
    ...
    'merge_zip_only_error': '❌ فقط .zip فایل supported, please re-upload',
    ...
    'merge_cancelشد': '❌ Merge operation cancelشد',
    'merge_no_files': '❌ بدون فایل uploaded',
    
    # ===== One-Click Cleanup Feature =====
    # 1. Feature Introduction Page
    'cleanup_title': '🧹 پاکسازی یک کلیکی',
    ...
    'cleanup_safety2': '· Auto-handle تلگرام rate limits',
    'cleanup_safety3': '· Generate detaiشد cleanup report',
    ...
    'cleanup_report_success': 'موفق',
    'cleanup_report_frozen': 'مسدود شده',
    'cleanup_report_faiشد': 'ناموفق',
    ...
    'cleanup_report_concurrent_mode': 'Concurrent mode: در حال پردازش {count} اکانت simultaneously',
    'cleanup_report_status_success': 'موفق',
    'cleanup_report_status_frozen': 'مسدود شده',
    'cleanup_report_status_faiشد': 'ناموفق',
    ...
    'cleanup_ensure_format': 'Please ensure ZIP contains Session or TData format فایل',
    'cleanup_no_pending_task': '❌ بدون pending cleanup task',
    'cleanup_operation_timeout': '❌ Operation timeout, please restart',
    'cleanup_processing_faiشد': '❌ در حال پردازش faiشد',
    'cleanup_error': 'خطا: {error}',
    ...
    'reauth_upload_prompt': '📤 Please upload account فایل',
    'reauth_supported_formats': 'فرمت های پشتیبانی شده: .session / TData folder / .zip archive',
    
    # 2. Buttons
    'reauth_btn_back': '◀️ بازگشت',
    ...
    'reauth_important2': '· در حال پردازش time depends on account count',
    ...
    'reauth_result_pwd_error': '· 🔑 رمز عبور خطا: {count}',
    'reauth_result_network': '· 🌐 Network خطا: {count}',
    'reauth_result_other': '· ⚠️ Other خطا: {count}',
    ...
    'reauth_no_valid_files': '❌ بدون valid فایل found',
    'reauth_ensure_format': 'Please ensure ZIP contains Session or TData format فایل',
    'reauth_faiشد': '❌ Re-authorization faiشد',
    ...
    'regtime_method1': '1. ✅ Get first message time from @تلگرام official chat (most accurate)',
    ...
    'regtime_note2': '2. Requires official تلگرام API',
    ...
    'regtime_process3': '• Classify اکانت by same date (Year-Month-Day)',
    'regtime_process4': '• Generate classification report and packaged فایل',
    ...
    'regtime_accuracy1': '1. First message in تلگرام official chat (most accurate)',
    ...
    'regtime_source_api': '• telegram_api / full_user_api: From تلگرام official API (✅ Most accurate)',
    'regtime_source_telegram': '• telegram_chat: From @تلگرام official chat (✅ Accurate)',
    ...
    'regtime_faiشد_accounts': 'ناموفق اکانت:',
    ...
    'regtime_fail_zip_name': 'query_faiشد',
    ...
    'regtime_processing_faiشد': '❌ در حال پردازش faiشد',
    'regtime_processing_error': 'خطا: {error}',
    
    # ===== Edit Profile Feature =====
    # 1. Feature Introduction Page
    'profile_title': '📝 Edit Profile',
    'profile_intro': 'This feature supports batch editing of account name, avatar, bio, username, etc.',
    'profile_random_mode_title': '🎲 Random Generation حالت:',
    ...
    'profile_note1': '1. تلگرام has rate limits for profile modifications',
    'profile_note2': '2. System will automatically add appropriate delays to avoid rate limiting',
    'profile_note3': '3. کاربرnames will be automatically checked for availability',
    ...
    'profile_config_username': '• کاربرname:',
    ...
    'profile_config_prompt': 'Please configure options or upload account فایل:',
    ...
    'profile_custom_upload_photo_assign': '• Each image will be assigned to اکانت in order',
    ...
    'profile_config_username_label': '└ کاربرname:',
    ...
    'profile_confirm_note3': '• کاربرnames will be automatically checked for availability',
    ...
    'profile_status_checking_username': 'بررسیing username availability...',
    'profile_status_processing_complete': '✅ در حال پردازش complete',
    ...
    'profile_action_avatar_upload_faiشد': '❌ Avatar upload faiشد',
    'profile_action_avatar_upload_faiشد_error': '❌ Avatar upload faiشد: {error}',
    'profile_action_bio_success': '✅ Bio: {bio}',
    'profile_action_bio_faiشد': '❌ Bio update faiشد',
    'profile_action_bio_faiشد_error': '❌ Bio update faiشد: {error}',
    ...
    'profile_action_username_faiشد_occupied': '❌ کاربرname update faiشد (may be taken)',
    ...
    'profile_processing_faiشد': '❌ در حال پردازش faiشد',
    'profile_error_msg': 'خطا: {error}',
    ...
    'contact_limit_format_title': 'فرمت های پشتیبانی شده:',
    'contact_limit_format_session': '• Session فایل (.session)',
    'contact_limit_format_tdata': '• TData پوشه',
    ...
    'member_btn_back_main': 'بازگشت to منوی اصلی',
    'member_btn_back_center': 'بازگشت to عضویت Center',
    'member_btn_retry': '🔄 Redeem Again',
    'member_btn_cancel': '❌ لغو',
    ...
    # 6. Redemption Faiشد
    'redeem_faiشد': '❌ Redemption ناموفق',
    ...
    'admin_btn_revoke_membership': 'Revoke عضویت',
    ...
    'user_management_user_prefix': 'کاربر',
    'user_management_btn_search': '🔍 Search کاربر',
    'user_management_btn_recent': '📋 Recent کاربرs',
    ...
    'search_user_by_id': 'کاربر ID (numbers only)',
    'search_user_by_username': 'کاربرname (@username or username)',
    'search_user_by_nickname': 'نام مستعار keywords',
    'search_user_example': 'Examples:',
    'search_user_example_id': '<code>123456789</code> - Search by کاربر ID',
    'search_user_example_username': '<code>@username</code> - Search by کاربرname',
    'search_user_example_nickname': '<code>9hao</code> - Search by نام مستعار',
    'search_user_timeout': '⏰ Auto-cancel if no input within 5 minutes',
    'search_user_send_prompt': 'Please send the search content...',
    'search_user_btn_cancel': '❌ لغو',
    ...
    'user_detail_username': 'کاربرname',
    'user_detail_membership_info': '💎 عضویت Info',
    ...
    'gift_membership_success': '✅ Gift موفقful!',
    'gift_membership_info': '📋 Gift Info',
    'gift_membership_target_user': 'Target کاربر',
    ...
    'proxy_test_confirm': 'تأیید to start testing?',
    'proxy_test_btn_start': '✅ Start Test',
    'proxy_test_testing': '🔄 Testing پروکسی...',
    'proxy_test_progress': '⏳ Test پیشرفت',
    ...
    'proxy_stats_faiشد_requests': 'ناموفق Requests',
    ...
    'proxy_optimize_enabشد': '🟢 فعال',
    'proxy_optimize_effect': '📈 Optimization Effect',
    'proxy_optimize_standard': 'Standard حالت',
    'proxy_optimize_accounts_sec': 'اکانت/sec',
    ...
    'proxy_optimize_tip1': 'Regularly clean invalid پروکسی to improve speed',
    'proxy_optimize_tip2': 'Use high-quality پروکسی for best performance',
    ...
    'manual_activation_formats': 'فرمت های پشتیبانی شده:',
    'manual_activation_format_id': 'کاربر ID (numbers only)',
    'manual_activation_format_username': 'کاربرname (@username)',
    'manual_activation_requirement': 'کاربر must interact with bot first',
    ...
    'revoke_membership_confirm': '⚠️ تأیید Revoke عضویت',
    ...
    'revoke_membership_btn_confirm': '✅ تأیید Revoke',
    'revoke_membership_success': '✅ Revoke موفقful!',
    'revoke_membership_info': '📋 Revoke Info',
    'revoke_membership_original_level': 'Original Level',
    'revoke_membership_original_expiry': 'Original انقضا',
    'revoke_membership_desc': 'موفقfully revoked user\'s membership privileges.',
    ...
    'broadcast_media_formats': 'فرمت های پشتیبانی شده: JPG, PNG, GIF',
    ...
    'broadcast_buttons_cancelشد': '❌ Broadcast Creation لغو شد',
    ...
    'broadcast_send_progress': 'پیشرفت',
